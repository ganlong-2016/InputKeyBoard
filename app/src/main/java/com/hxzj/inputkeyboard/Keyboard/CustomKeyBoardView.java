...
public class CustomKeyBoardView extends KeyboardView {
    ...
    public void onDraw(Canvas canvas) {
        if (null == getKeyboard() || !(getKeyboard() instanceof CustomKeyboard) || null == ((CustomKeyboard) getKeyboard()).getCustomKeyStyle()) {
            super.onDraw(canvas);
            return;
        }
    ...
    private void onRefreshKey(Canvas canvas) {
        ...
        EditText etCur = ((CustomKeyboard) getKeyboard()).getCurEditText();
        CustomKeyboard.CustomKeyStyle customKeyStyle = ((CustomKeyboard) getKeyboard()).getCustomKeyStyle();
